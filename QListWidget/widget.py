from PySide6.QtWidgets import QWidget, QPushButton, QVBoxLayout , QLabel, QHBoxLayout, QLineEdit, QAbstractItemView, QListWidget
...
class Widget(QWidget):
    def __init__(self):
        ...
        button_count_item = QPushButton('Count Item')
        button_count_item.clicked.connect(self.count_item)
        button_selected_items =QPushButton("Select item")
        button_selected_items.clicked.connect(self.selected_item)
        ...
        v_layout.addWidget(button_count_item)
    ...
    def count_item(self):
       print('Total item:',self.list_widget.count()) 
